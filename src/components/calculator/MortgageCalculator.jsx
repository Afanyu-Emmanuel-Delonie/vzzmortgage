...
function MortgageCalculator() {
  ...
  return (
    <section className='py-8 sm:py-12 md:py-16 px-4 sm:px-6 md:px-10 lg:px-20 bg-white'>
      <div className='max-w-7xl mx-auto'>
        ...
        <p className='text-sm sm:text-base text-center pb-6 sm:pb-10 px-2 text-gray-600 max-w-2xl mx-auto'>
        ...
        <div className='bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-lg'>
          <div className='grid md:grid-cols-2 gap-6 items-center sm:gap-8'>
              ...
              <div className="space-y-5 sm:space-y-6">
                ...
                <div>
                  <div className="flex justify-between items-center mb-2 sm:mb-3">
                    ...
                    <span className="text-base sm:text-lg font-bold text-[#4A5F8C]">${homePrice.toLocaleString()}</span>
                  </div>
                  <input
                    type="range"
                    min="50000"
                ...
                <div>
                  <div className="flex justify-between items-center mb-2 sm:mb-3">
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                      <span className="text-base sm:text-lg font-bold text-[#4A5F8C]">${downPayment.toLocaleString()}</span>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2 sm:mb-3">
                    ...
                    <span className="text-base sm:text-lg font-bold text-[#4A5F8C]">{interestRate.toFixed(2)}%</span>
                  </div>
                  <input
                    type="range"
                    min="2"
                ...
                <div>
                  <div className="flex justify-between items-center mb-2 sm:mb-3">
                    ...
                    <span className="text-base sm:text-lg font-bold text-[#4A5F8C]">{loanTerm} years</span>
                  </div>
            ...
            {/* Results - Right Side */}
            <div className="space-y-4 sm:space-y-6 bg-[#F3F4F7] rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 text-[#1a2844]">
              {/* Monthly Payment Card */}
              <div>
                <p className="text-xs sm:text-sm text-gray-600 mb-1">Estimated Monthly Payment</p>
                {loading ? (
                  <div className="flex items-center gap-3 mb-4 sm:mb-6">
                    <div className="animate-spin rounded-full h-6 w-6 sm:h-8 sm:w-8 border-b-2 border-yellow-400"></div>
                    <span className="text-lg sm:text-xl text-gray-600">Calculating...</span>
                  </div>
                ) : (
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                <div className="bg-white/90 rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-sm">
                  <p className="text-xs sm:text-sm text-gray-600 mb-1 sm:mb-2">Loan Amount</p>
                  <p className="text-lg sm:text-2xl font-bold break-words">
                    ${loanAmount.toLocaleString()}
                  </p>
                </div>
                <div className="bg-white/90 rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-sm">
                  <p className="text-xs sm:text-sm text-gray-600 mb-1 sm:mb-2">Total Interest</p>
                  <p className="text-lg sm:text-2xl font-bold break-words">
              ...
              {/* Payment Breakdown */}
              <div className="bg-white/90 rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-sm">
                <h4 className="text-base sm:text-lg font-bold mb-3 sm:mb-4 text-[#102044]">Payment Breakdown</h4>
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex justify-between items-center gap-2">
                    <span className="text-gray-600 text-xs sm:text-sm">Principal & Interest</span>
                  ...
                  <div className="border-t border-gray-300 pt-2 sm:pt-3 mt-2 sm:mt-3">
                    <div className="flex justify-between items-center gap-2">
                      ...
                      <span className="font-bold text-lg sm:text-xl text-yellow-600">
          ...
          <div className="mt-6 sm:mt-8">
            <p className='text-xs sm:text-sm text-center text-gray-500 max-w-3xl mx-auto'>
              This calculator provides estimates only. Actual monthly payments may vary based on additional factors such as HOA fees, PMI, and other costs. Please consult with a mortgage professional for accurate quotes.
            </p>
          </div>
        </div>
      </div>
