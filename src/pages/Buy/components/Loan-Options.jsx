      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-[#111111] mb-4">
            Explore Your <span className="text-yellow-500">Mortgage</span>{" "}
            Options
          </h2>
          <p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
            Find the perfect loan that fits your financial situation and home
            ownership goals
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex justify-end items-start">
                  <div
                    className={`flex gap-2 py-1.5 px-3 items-center rounded-full border ${
                      tagStyles[loan.tagColor]
                    }`}
                  >
