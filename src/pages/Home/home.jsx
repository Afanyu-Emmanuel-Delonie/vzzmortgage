      ...
      <div className="section py-10 bg-white">
        <div className="container justify-center">
          <h2 className="text-[#111111] text-center pb-15">
            Choose <span className="text-yellow-500">Your path</span> To Closing
          </h2>
            ...
            <div>
              ...
              <div className="space-y-6 mb-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Apply online in minutes, with trusted experts ready
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">
                      A Faster, Simpler Mortgage Experience
                    </h3>
                    <p className="text-gray-300">
                      Streamlined applications and eClosings keep things moving
                      without the hassle.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">
                      More Ways to Own With Confidence
                    </h3>
                    <p className="text-gray-300">
                      Programs and pricing designed to help you buy, refinance,
                      or unlock equity wisely.
                    </p>
                  </div>
                </div>
              </div>
